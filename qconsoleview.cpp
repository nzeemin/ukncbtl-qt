...
int QConsoleView::printDisassemble(CProcessor* pProc, WORD address, BOOL okOneInstr, BOOL okShort)
{
...
void QConsoleView::printMemoryDump(CProcessor *pProc, WORD address, int lines)
{
